...
function _admNovo(){
  ...
  ov.innerHTML='<div style="width:400px;background:#12121e;border:1px solid #252540;border-radius:16px;padding:26px 24px;max-height:90vh;overflow:auto">'
    ...
    +'<label style="'+lCss+'">Papel</label><select id="nv-role" style="'+iCss+'"><option value="super">Superintendente</option><option value="regional">Regional</option><option value="comercial">Comercial</option><option value="admin">Admin</option><option value="pronto">Pronto</option></select>'
...
function _admEditar(login){
  ...
  ov.innerHTML='<div style="width:400px;background:#12121e;border:1px solid #252540;border-radius:16px;padding:26px 24px">'
    ...
    +'<label style="'+lCss+'">Papel</label><select id="ed-role" style="'+iCss+'"><option value="admin">Admin</option><option value="super">Superintendente</option><option value="regional">Regional</option><option value="comercial">Comercial</option><option value="pronto">Pronto</option></select>'
